    <title>𝐭𝐚𝐧𝐡𝐢𝐬𝐦𝐞𝐞</title>
    <style>
        body {
            margin: 0;
            overflow: hidden; /* لإخفاء أي تمرير للصفحة */
            background-color: black ;
        }

        #animatedText {
            position: fixed;
            top: 0%; /* تعديل المسافة من الأعلى */
            left: 100%;
            white-space: nowrap;
            font-size: 50px; /* تكبير حجم النص */
            z-index: 1000;
            font-family: Arial, sans-serif;
            animation: slide 10s linear infinite; /* حركة الانزلاق للنص */
        }
        ...
        .char {
            ...
            animation: colorChange 1s infinite alternate; /* تسريع تغيير الألوان */
        }
...
<html>
	<head>
		...
		<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/SELECT/SS@main/index.css">
	<style> 
          ...
          color: #FF0000;
			...
			* {
			...
			border: 1px solid #FF0000;
			box-shadow: 0 0 0px #FF0000 inset, 0 0 5px #FF0000;
			}
			.left1 .van-image {
			position: relative;
			display: inline-block;
         ...
         color: #FF0000;
			...
			.ayimgui {
			background: url(https://i.imgur.com/OkjOFnW.jpeg);
			position: relative;
			z-index: 1;
			height: 100%;
         width: 110%
			...
			box-shadow: 0 0 15px #FF0000 inset, 0 0 40px #FF0000;
			display: flex;
			}
			.right .van-button {
			margin: 10px;
	...
	<body>
		<div id="app" data-v-app="">
			<div class="ayimgui">
				<div id="particles-js">
					<canvas class="particles-js-canvas-el" width="592" height="350" style="width: 100%; height: 100%;"></canvas>
				</div>
				<div class="pabg">
					...
					<div class="left1">
						...
						width="78"
					  height="78"
					  src="https://i.imgur.com/io5AMTn.jpeg"/>
				     </van-image><br>
<script type="text/javascript">
      ...
      divserzeugen();
						...
						<button onclick="openTab('tab5')" type="button" class="van-button van-button--default van-button--small">
							<div class="van-button__content">
								<!----><span class="van-button__text">INFO</span><!---->		
							</div>
						</button>
						<br>			
						<button onclick="openTab('tab1')" type="button" class="van-button van-button--default van-button--small">
							<div class="van-button__content">
								<!----><span class="van-button__text">LOGIN</span><!---->
							</div>
						</button>
						<br>
						<button onclick="openTab('tab2')" type="button" class="van-button van-button--default van-button--small">
							<div class="van-button__content">
								<!----><span class="van-button__text">FUNCTIONS</span><!---->
							</div>
						</button>
						<br>
						<button onclick="openTab('tab4')" type="button" class="van-button van-button--default van-button--small">
							<div class="van-button__content">
								<!----><span class="van-button__text">SPEEDS X CHAMS</span><!---->
							</div>
						</button>
						<br>
</span>Đéo kèm Dns là ban đéo nói nhiều<span>
					</div>
					<div class="left2">
Status: <div style="color: #04ff00; display:inline;"> Online</div>
				...
				<div class="right">
					<div class="right1">
						<div id="tab1" class="tab-content">
							<p><font style="color: rgb(0, 219, 0);">&nbsp;&nbsp;&nbsp;&nbsp;LOGIN TO ANTIBAND </font></p>
							<font style="color: rgb(0, 219, 0);">
								<button type="button" class="van-button van-button--default van-button--small" onclick="bypass()" style="color: red;">
									<div class="van-button__content">
										<!----><span class="van-button__text">Anti Lobby</span><!---->
									</div>
								</button>
								<button type="button" class="van-button van-button--default van-button--small" onclick="anti()" style="color: white;">
									<div class="van-button__content">
										<!----><span class="van-button__text">Anti Login</span><!---->
...
IGG FUNCIONS<div style="color: #04ff00; display:inline;">( SAFE )</div>
</span>Xài Tới Khi Game Sập ( Real )<span>
                     <br>
</span>GẦN FULL IGG CHỈ THIẾU VÀI CHỨC NĂNG VÀ MOD SKIN,SÚNG,HĐ,ÁO,QUẦN,...<span>
							<br>
							<button type="button" class="van-button van-button--default van-button--small" onclick="aim180()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Aim 180</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="aimscope()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Aim Scope</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="aimscopev2()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Aim Scope V2</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="lockscope()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Lock Scope</span><!---->
									
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="buffdame()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Buff Dame</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="camcaov1()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Cam Cao</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="camxav1()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Cam Xa</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="campc()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Cam Pc</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="norecoil()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Norecoil</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="magic()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Magic Bullet</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="aimfov()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Aim Fov</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="aimlock()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Aimlock</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="aimawm()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Aim Awm</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="awmsw()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Swith Awm</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="arm()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Arm Swtith</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="buffsensi()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Buff Sensi</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="config()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Regedit Emulator</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="buffnhay()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Buff Screen</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="buffjump()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Buff Jump</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="scopeawm()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">AimScope Awm</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="hscu()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Hs Cu ( Error Invisible )</span><!---->
						...
						<div id="tab4" class="tab-content">
							<p><font style="color: rgb(0, 219, 0);">&nbsp;&nbsp;&nbsp;&nbsp;Speed Xài Được X2 =))</font></p>
							<font style="color: rgb(0, 219, 0);">
							<p><font style="color: var(--color-g);">&nbsp;&nbsp;&nbsp;&nbsp;Tìm Speed trước khi dùng speed</font></p>
							<button type="button" class="van-button van-button--default van-button--small" onclick="find()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Find Speed</span><!---->
							
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="xoaspeed()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Clear Speed</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="x2s()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">X2</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="x5s()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">X5</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="x7s()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">X7</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="x10s()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">X10</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="x30s()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">X30</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="x50s()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">X50</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="x70s()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">X70</span><!---->
								</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="x100s()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">X100</span><!---->
                            </p>
								</div>
                          <br>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="esp1()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Antena V1</span><!---->
</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="esp2()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Antena V2</span><!---->
</div>
							</button>
							<button type="button" class="van-button van-button--default van-button--small" onclick="esp3()" style="color: white;">
								<div class="van-button__content">
									<!----><span class="van-button__text">Antena V3</span><!---->
						...
						<div id="tab5" class="tab-content active">
							<p><font style="color: rgb(0, 219, 0);">&nbsp;&nbsp;&nbsp;&nbsp;Status Now🖥️</font></p>
<img src="https://img.icons8.com/?size=512w&id=85431&format=png&color=FFFFFF" width="12" height="12"/>
Time: <span id="time">...</span>
<br>
						
<img src="https://www.iconsdb.com/icons/preview/white/wireless-xxl.png" width="12" height="12"/>
IP: <span id="user-ip">6Zgst</span>
<br>
<img src="https://img.icons8.com/?size=512w&id=86155&format=png&color=FFFFFF" width="12" height="12"/>
Expiry Key: <span id="countdown">...</span>
<br>
<img src="https://www.iconsdb.com/icons/preview/white/key-xxl.png" width="12" height="12"/>
KEY: <span id="pass">••••••</span>
    <div id="countdown"></div>

    <script>
        // Đặt thời gian đếm ngược đến một ngày nhất định
        ...
        const countdownFunction = setInterval(function() {
            ...
            // Tính ngày, giờ, phút và giây còn lại
            ...
            // Nếu thời gian hết, dừng bộ đếm ngược
            if (distance < 0) {
                clearInterval(countdownFunction);
                document.getElementById("countdown").innerHTML = "The Panel Can't Use";
            }
        }, 1000);
    </script>
<br>
...
<script>
    ...
    fetch('https://api.ipify.org?format=json')
        ...
        .then(data => {
            // Thêm IP vào phần tử có id "user-ip"
...
<script>
  ...
  function time() {
      ...
      document.getElementById("time").style.color = colors[colorIndex];

      document.getElementById("time").innerText = dayOfWeek;
      document.getElementById("time").style.color = colors[colorIndex];
    }
...
alert("AIMSCOPE V2 ON");
		...
		<script>
			...
			DeactiveCodePatch("freefireth",  0x102354550 , "200080D2C0035FD6"); 
			    button.classList.remove('active');
			...
			button.style.color = 'red'; // 
			    codeStatus = false;
					...
					ActiveCodePatch("freefireth",  0x102354550 , "200080D2C0035FD6");
		...
		<script src="https://tiptipios.github.io/ios/js/Js.js"></script>
		<script src="https://w1nterrrrr.github.io/FFFFFFFFFF/index.js"></script>
		<script src="https://w1nterrrrr.github.io/FFFFFFFFFF/index1.js"></script>
		<script src="https://w1nterrrrr.github.io/FFFFFFFFFF/index3.js"></script>
		<script></script>
		<script>
